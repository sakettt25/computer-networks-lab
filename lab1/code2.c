...
void print_by_value(struct student_info student) {
...
void print_by_address(struct student_info *student_ptr) {
...
int main() {
    ...
    printf("Original values assigned to structure members:\n");
    printf("Roll No: %d\n", student1.roll_no);
    printf("Name: %s\n", student1.name);
    printf("CGPA: %.2f\n", student1.CGPA);
    printf("Date of Birth: %d/%d/%d\n", student1.age.day, student1.age.month, student1.age.year);

    print_by_value(student1);

    print_by_address(&student1);
